...
// Create a clean, working OpenShifts component
const cleanOpenShifts = `import { useState } from 'react';
...
fs.writeFileSync('src/components/OpenShifts.tsx', cleanOpenShifts);
console.log('✅ Created clean OpenShifts.tsx component');
